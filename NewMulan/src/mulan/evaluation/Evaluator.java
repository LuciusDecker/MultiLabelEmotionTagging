...
public class Evaluator {
    ...
    public Evaluation evaluate(MultiLabelLearner learner, MultiLabelInstances data, List<Measure> measures) throws IllegalArgumentException, Exception {
        ...
        String Filename = "EPSLabeledData_predict20140331.txt";
        BufferedWriter tw = new BufferedWriter(new FileWriter(new File(Filename),true));
        //==============================================
        ...
        for (int instanceIndex = 0; instanceIndex < numInstances; instanceIndex++) {
            ...
            String StrTrueLabel = "[";
            for(int m=0;m<trueLabels.length;m++){
            	StrTrueLabel += trueLabels[m] + ",";
            }
            StrTrueLabel += "]";
            tw.write(instanceIndex+ " True label set is: " +  StrTrueLabel);
            tw.newLine();
            tw.write(instanceIndex + "Predict label set is "+ output.toString());
            tw.newLine();
            //end ============================
        ...
        tw.write("add_cost:"+((double) (t1 - start) / (1000 * 1000 * 1000))+ "s");
        tw.newLine();
        tw.close();
